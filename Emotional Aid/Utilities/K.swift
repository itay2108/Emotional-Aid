...
import UIKit
    ...
    struct K {
        ...
        struct text {
            ...
            static let successDescription = "Поздравляем, вы  проделали огромную работу и помогли себе справиться со стрессом! Перед тем, как начать сессию, вы оценили своё состояние ____, сейчас оно ____. Рады, что вам удалось приблизиться к балансу! С каждым разом ваша нервная система будет всё увереннее овладевать навыком саморегуляции. Если что, мы рядом!"
        }

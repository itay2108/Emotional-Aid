...
import UIKit
    ...
    struct K {
        ...
        struct text {
            ...
            static let verificationDescription = "We have sent an email to \(UserDefaults.standard.string(forKey: K.def.email) ?? "NaN@mail.co") to verify your email address and activate your account."
            ...
            static let privacyAndTermsDescription: NSMutableAttributedString = {
                ...
                let attributedString = NSMutableAttributedString(string: "By signing up, you agree to our Privacy policy and Terms & conditions", attributes: [.paragraphStyle: style])
                
                attributedString.addAttribute(.link, value: "https://www.hackingwithswift.com", range: NSRange(location: 32, length: 14))
                attributedString.addAttribute(.font, value: FontTypes.shared.ubuntuMedium.withSize(11 * UIViewController().heightModifier), range: NSRange(location: 32, length: 14))
                
                attributedString.addAttribute(.link, value: "https://www.hackingwithswift.com", range: NSRange(location: 51, length: 18))
                attributedString.addAttribute(.font, value: FontTypes.shared.ubuntuMedium.withSize(11 * UIViewController().heightModifier), range: NSRange(location: 51, length: 18))

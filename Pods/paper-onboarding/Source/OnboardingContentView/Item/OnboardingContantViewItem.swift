...
open class OnboardingContentViewItem: UIView {
    ...
    private var heightModifier = UIScreen.main.bounds.height / 812
    private var widthModifier = UIScreen.main.bounds.width / 375
...
private extension OnboardingContentViewItem {
    ...
    func createDescriptionLabel(_ onView: UIView, padding: CGFloat) -> UILabel {
        ...
        for (attribute, constant) in [(NSLayoutConstraint.Attribute.leading, 44 * widthModifier), (NSLayoutConstraint.Attribute.trailing, -44 * widthModifier)] {
            (onView, label) >>>- {
                $0.attribute = attribute
